...
/**
 * Login Controller for Admin/Staff Login
 * @author KU 
 */
...
//        $verification_code = $this->encrypt->decode($verification_code);
    ...
    public function check_email() {
        ...
        $user = $this->users_model->get_user_detail(['email' => $requested_email, 'is_delete' => 0, 'is_active' => 1]);
        if ($user) {
            echo "true";
        } else {
            echo "false";
