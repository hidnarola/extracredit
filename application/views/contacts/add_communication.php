...
<div class="page-header page-header-default">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('contacts/communication/' . base64_encode($contact['id'])); ?>"><i class="icon-comment-discussion"></i> Communication</a></li>
                    ...
                    <form class="form-horizontal form-validate-jquery" action="" id="add_conversation_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                    <input type="text" name="follow_up_date" id="follow_up_date" placeholder="Enter Follow Up Date" class="form-control followdate" value="<?php echo (isset($contact_communication) && !empty($contact_communication['follow_up_date'])) ? date('d F Y', strtotime($contact_communication['follow_up_date'])) : set_value('follow_up_date'); ?>">
                                </div>
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="subject" id="subject" placeholder="Enter Subject" class="form-control" required="required" value="<?php echo (isset($contact_communication) && $contact_communication['subject']) ? $contact_communication['subject'] : set_value('subject'); ?>">
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <textarea name="note" id="editor-full" rows="4" cols="4">										
                                    <?php echo (isset($contact_communication)) ? $contact_communication['note'] : set_value('note'); ?>			
                                </textarea>
                                <?php
                            ...
                            <div class="col-lg-6">
                                <div class="media no-margin-top">
                                    <div class="media-left" id="image_preview_div">
                                        <?php
                                        $required = 'required';
                                        if (isset($contact_communication) && $contact_communication['media'] != '') {
                                            $required = '';
                                            if (preg_match("/\.(gif|png|jpg)$/", $contact_communication['media'])) {
                                                ?>
                                                <img src="<?php echo COMMUNICATION_IMAGES . $contact_communication['media']; ?>" style="width: 58px; height: 58px; border-radius: 2px;" alt="">
                                            <?php } else { ?>
                                                <a class="fancybox" target="_blank" href="<?php echo COMMUNICATION_IMAGES . $contact_communication['media']; ?>" data-fancybox-group="gallery" ><img src="assets/images/default_file.png" height="55px" width="55px" alt="" class="img-circle"/></a>
                                                <?php
                                            }
                                        } else {
                                            ?>
