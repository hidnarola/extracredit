...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-coins"></i> <span class="text-semibold">Guests Report</span></h4>
        </div>
    </div>
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="<?php echo site_url('home'); ?>"><i class="icon-home2 position-left"></i> Home</a></li>
            <li class="active">Guests Report</li>
        </ul>
    </div>
</div>
<div class="content">
    ...
    <div class="panel panel-flat custom_perpage_dropdown">
        ...
        <table class="table"  id="donors_report">
            ...
            <?php foreach($guests as $row) {?>
                <tr>                       
                    <td><?php if(isset($row['firstname']) and $row['firstname'] != ''){echo $row['firstname'];}else{echo '-';} ?></td>
                    <td><?php if(isset($row['lastname']) and $row['lastname'] != ''){echo $row['lastname'];}else{echo '-';} ?></td>
