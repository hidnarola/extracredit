...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-coins"></i> <span class="text-semibold">Vendors Report</span></h4>
        </div>
    </div>
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="<?php echo site_url('home'); ?>"><i class="icon-home2 position-left"></i> Home</a></li>
            <li class="active">Vendors Report</li>
        </ul>
    </div>
</div>
<div class="content">
    ...
    <div class="panel panel-flat custom_perpage_dropdown">
        ...
        <table class="table"  id="donors_report">
            ...
            <?php foreach($vendors as $row) {?>
                <tr>                       
                    <td><?php if(isset($row['name']) and $row['name'] != null) { echo $row['name']; }else{echo '-';} ?></td>
                    <td><?php if(isset($row['email']) and $row['email'] != null){echo $row['email']; }else{echo '-';} ?></td>
                    <td><?php if(isset($row['contact_name']) and $row['contact_name'] != null){ echo $row['contact_name'] ;}else{ echo '-' ;} ?></td>
