...
<?php
$edit = 0;
if (isset($account_communication)) {
    $edit = 1;
}
?>
                ...
                <div class="panel-body">
                    <form class="form-horizontal form-validate-jquery" action="" id="add_conversation_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="subject" id="subject" placeholder="Enter Subject" class="form-control" required="required" value="<?php echo (isset($account_communication) && $account_communication['subject']) ? $account_communication['subject'] : set_value('subject'); ?>">
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <textarea name="note" id="editor-full" rows="4" cols="4">										
                                    <?php echo (isset($account_communication)) ? $account_communication['note'] : set_value('note'); ?>			
                                </textarea>
                                <?php
                            ...
                            <div class="col-lg-6">
                                <div class="media no-margin-top">
                                    <div class="media-left" id="image_preview_div">
                                        <?php
                                        $required = 'required';
                                        if (isset($account_communication) && $account_communication['media'] != '') {
                                            $required = '';
                                            if (preg_match("/\.(gif|png|jpg)$/", $account_communication['media'])) {
                                                ?>
                                                <img src="<?php echo COMMUNICATION_IMAGES . $account_communication['media']; ?>" style="width: 58px; height: 58px; border-radius: 2px;" alt="">
                                            <?php } else { ?>
                                                <a class="fancybox" target="_blank" href="<?php echo COMMUNICATION_IMAGES . $account_communication['media']; ?>" data-fancybox-group="gallery" ><img src="assets/images/default_file.png" height="55px" width="55px" alt="" class="img-circle"/></a>
                                                <?php
                                            }
                                        } else {
                                            ?>
