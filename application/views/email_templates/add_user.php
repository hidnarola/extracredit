            ...
            <tr>
                <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                        <tr>
                            <td align='center' valign='top'>
                                <h2>Invitation to join Extra Credit Show!</h2>
                                <p>Hello <?php echo $firstname . ' ' . $lastname ?>,You have been invited to join Extra Credit Show! Following are your account details. Click on below link to login</p>
                            </td>
                        </tr>
                        <tr>
                            <td align='center' valign='top'>
                                <h4 style='color: #26A69A !important'>Account Information</h4>
                            </td>
                        </tr>
                        <tr>
